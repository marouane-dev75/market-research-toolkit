...
from ..console.logger import get_logger, set_log_level
...
class CLIManager:
    ...
    def _show_default_help(self) -> int:
        ...
        self.logger.print_header("Ticker Financial Analysis Tool", width=60)
        self.logger.print_section("USAGE")
        self.logger.print_bullet("python -m ticker_analysis <command> [options]")
    ...
    def _show_version(self) -> None:
        ...
        self.logger.print_header("Ticker Financial Analysis Tool")
        self.logger.info("Version: 1.0.0")
        self.logger.info("A comprehensive tool for financial ticker analysis")
        self.logger.info("Built with Python and designed for extensibility")
