...
from .commands.income import IncomeCommand
from .commands.balance import BalanceCommand
from .commands.cashflow import CashFlowCommand
from .commands.dividend import DividendCommand
from .commands.price import PriceCommand
from .commands.info import InfoCommand
from .commands.cache import CacheCommand
from .commands.analysis import AnalysisCommand
...
class CommandRegistry:
    ...
    def _register_default_commands(self) -> None:
        ...
        self.register_command(IncomeCommand())
        self.register_command(BalanceCommand())
        self.register_command(CashFlowCommand())
        self.register_command(DividendCommand())
        self.register_command(PriceCommand())
        self.register_command(InfoCommand())
        self.register_command(CacheCommand())
        self.register_command(AnalysisCommand())
        self.register_command(MagicCommand())
        self.register_command(MonitorCommand())
